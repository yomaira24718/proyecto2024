...
<body>
<form class="col-8 mx-auto" action="../controller/controlRegisRol.php" method="POST">
                        <h3 class="text-center text-secondary">Registro Rol</h3>

                      
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Descripcion Rol</label>
